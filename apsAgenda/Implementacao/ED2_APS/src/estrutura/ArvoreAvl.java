...
public class ArvoreAvl {
    ...
    private int getQtdNode(No root) {
        ...
        int qtdNodeEsq = getQtdNode(root.getEsquerda());
        int qtdNodeDireita = getQtdNode(root.getDireita());
    ...
    public No procuraChave(int valorProcurado, No no) {
        int valor;
        if (no == null) {
            return null;
        }
        ...
        if (valorProcurado < valor) {
            return procuraChave(valorProcurado, no.getEsquerda());
        } else {
            return procuraChave(valorProcurado, no.getDireita());
        }
    }
}
